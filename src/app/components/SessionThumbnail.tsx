...
export function SessionThumbnail({ 
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-4">
      {/* Template 1: Session Thumbnail - 600x800 */}
      <div className="relative h-[800px] w-[600px] overflow-hidden rounded-3xl bg-white shadow-2xl">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center px-12 text-center">
          ...
          {/* Black Pill Label */}
          <div className="mb-12 inline-block rounded-full bg-black px-10 py-3">
          ...
          {/* Main Title */}
          <h1 className="mb-8 font-['Montserrat'] text-6xl font-black leading-tight text-black">
            {sessionTitle}
          </h1>

          {/* Subtext */}
          <p className="font-['Pretendard'] text-2xl font-medium text-gray-800">
            GDGoC DEU 신규 세션/활동 기록
          </p>
          
          {/* Session Date */}
          <p className="mt-4 font-['Pretendard'] text-xl font-semibold text-gray-900">
            {sessionDate}
          </p>
        </div>
